...
- 本目录里的文件齐全，最多证明资产到达 `BUILT`；只有学习者本人完成冻结题、未见题和延迟复测，能力轴才会移动。
...
| 包 | 模块 | 目标 |
|---|---|---|
| EdgeIM | [B-S2](edgeim/B-S2/README.md) | hash 分派与局部 `S_i/E_i/R_i` |
| EdgeIM | [B-S3A](edgeim/B-S3A/README.md) | 中心 union/sum 与全局 weighted DFG |
| EdgeIM | [B-S3B](edgeim/B-S3B/README.md) | 论文递归编排、经典 IM 补充层、Petri net/soundness 边界 |
| EdgeIM | [B-EVAL](edgeim/B-EVAL/README.md) | 实验合同、表格复算、全部 major claim |
| EdgeIM | [B-DEFENSE](edgeim/B-DEFENSE/README.md) | related work、限制、四档表达与 D1 |
| sigRank | [P0-P3](sigrank/P0-P3/README.md) | 全文地图、两阶段机制、evidence、attack/defense |
| Ground Truth | [P0-P3](ground-truth/P0-P3/README.md) | 世界生成、oracle 分离、实验与迁移 |
| CrossEdgeIM | [P0-P3](crossedgeim/P0-P3/README.md) | 三层增量架构、证据、谱系与 residual |
